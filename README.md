...
Desktop execution: [recording, experience guidance and Baseline](docs/desktop-baseline.md) — primary-screen, cross-window control with optional reviewed semantic guidance.
